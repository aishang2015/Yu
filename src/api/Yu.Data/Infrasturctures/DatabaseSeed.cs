...
namespace Yu.Data.Infrasturctures
{
    ...
    public static class DatabaseSeed
    {
        ...
        {
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('9807863c-b234-4452-7d57-08d708fe7bef','账户管理-用户名密码登陆','Account','POST','/api/Account/Login')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('47317471-a6d6-4c6f-7d58-08d708fe7bef','账户管理-刷新token','Account','POST','/api/Account/RefreshToken')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('8b02d6f4-c6e7-44ea-7d59-08d708fe7bef','账户管理-修改密码','Account','POST','/api/Account/ChangePwd')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('4768aa73-11a1-4016-7d5a-08d708fe7bef','验证码-获取验证码','Captcha','GET','/api/Captcha')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('b23935af-93a3-4eee-7d5b-08d708fe7bef','接口管理-取得全部Api数据','Api','GET','/api/allApi')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('ec48a0c4-ffed-43ad-7d5c-08d708fe7bef','接口管理-取得API数据','Api','GET','/api/api')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('308b4d8f-5db1-47e4-7d5d-08d708fe7bef','接口管理-添加API数据','Api','POST','/api/api')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('cb72e62b-60cb-4188-7d5e-08d708fe7bef','接口管理-更新api数据','Api','PUT','/api/api')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('edfd819d-2424-446f-7d5f-08d708fe7bef','接口管理-删除api数据','Api','DELETE','/api/api')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('fa75a6b9-743e-4961-7d60-08d708fe7bef','页面元素管理-取得页面元素','Element','GET','/api/element')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('3e76b4cf-0ff3-4b75-7d61-08d708fe7bef','页面元素管理-添加新元素','Element','POST','/api/element')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('ff573676-00ce-46cf-7d62-08d708fe7bef','页面元素管理-删除元素','Element','DELETE','/api/element')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('7d619e77-c7c4-446b-7d63-08d708fe7bef','页面元素管理-更新元素','Element','PUT','/api/element')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('7a90f207-ec2a-435b-7d64-08d708fe7bef','实体管理-取得实体数据(下拉框用)','Entity','GET','/api/entities')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('b4d9c97c-a17d-48e5-7d65-08d708fe7bef','实体管理-取得实体数据','Entity','GET','/api/entity')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('3f047f21-0c05-4f78-7d66-08d708fe7bef','实体管理-添加实体数据','Entity','POST','/api/entity')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('1cbfc955-a4a4-48a2-7d67-08d708fe7bef','实体管理-更新实体数据','Entity','PUT','/api/entity')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('5b3acd28-4d57-46ce-7d68-08d708fe7bef','实体管理-删除实体数据','Entity','DELETE','/api/entity')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('598f8a41-6857-4012-7d69-08d708fe7bef','组织结构管理-取得所有组织','Group','GET','/api/group')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('0273a51b-6a4e-4b77-7d6a-08d708fe7bef','组织结构管理-删除组织','Group','DELETE','/api/group')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('22e89a74-3e03-4f1d-7d6b-08d708fe7bef','组织结构管理-添加组织','Group','POST','/api/group')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('a97d11cb-a691-4567-7d6c-08d708fe7bef','组织结构管理-更新组织','Group','PUT','/api/group')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('b809dfc3-7af0-43c1-7d6d-08d708fe7bef','角色管理-取得全部角色名称','Role','GET','/api/roleNames')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('75e133dc-63ae-4027-7d6e-08d708fe7bef','角色管理-取得角色概要数据','Role','GET','/api/roleOutline')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('26b0f3a0-dd75-4e44-7d6f-08d708fe7bef','角色管理-取得角色详细数据','Role','GET','/api/role')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('0df18f48-730c-4398-7d70-08d708fe7bef','角色管理-删除角色数据','Role','DELETE','/api/role')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('6330e0bd-42fc-4ac6-7d71-08d708fe7bef','角色管理-添加角色','Role','POST','/api/role')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('90678f43-39c7-4ccf-7d72-08d708fe7bef','角色管理-更新角色','Role','PUT','/api/role')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('8488942f-ed09-4d55-7d73-08d708fe7bef','规则管理-查看所有规则组','Rule','GET','/api/ruleGroup')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('a6b958f7-5d93-456c-7d74-08d708fe7bef','规则管理-查看规则组内容','Rule','GET','/api/ruleDetail')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('34a24768-5d7b-4ead-7d75-08d708fe7bef','规则管理-删除规则组','Rule','DELETE','/api/ruleGroup')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('09861d8a-2d36-4d6f-7d76-08d708fe7bef','规则管理-添加修改规则组','Rule','PUT','/api/ruleDetail')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('5b343f0f-d587-4e10-7d77-08d708fe7bef','用户管理-取得用户概要情报','User','GET','/api/userOutline')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('3220f72a-a4ca-4326-7d78-08d708fe7bef','用户管理-取得用户数据','User','GET','/api/userDetail')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('afb4c264-b57a-4936-7d79-08d708fe7bef','用户管理-添加新用户','User','POST','/api/userDetail')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('40998129-255c-4edf-7d7a-08d708fe7bef','用户管理-更新用户数据','User','PUT','/api/userDetail')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('7ec86556-becf-49f3-7d7b-08d708fe7bef','用户管理-删除用户数据','User','DELETE','/api/userDetail')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('65f688c1-c679-4d38-7d7c-08d708fe7bef','用户管理-设置用户头像','User','POST','api/userAvatar')");
            ...
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"ElementApi\"(\"Id\",\"ElementId\",\"ApiId\")VALUES('d42a94ac-01b5-4848-361c-08d709ca74e9','ad592b36-dd5b-447b-fa6d-08d7072f517b','5b343f0f-d587-4e10-7d77-08d708fe7bef')");
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"ElementApi\"(\"Id\",\"ElementId\",\"ApiId\")VALUES('a98623fb-55ef-4aed-361d-08d709ca74e9','ad592b36-dd5b-447b-fa6d-08d7072f517b','b809dfc3-7af0-43c1-7d6d-08d708fe7bef')");
