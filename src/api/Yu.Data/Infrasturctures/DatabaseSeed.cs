...
namespace Yu.Data.Infrasturctures
{
    ...
    public static class DatabaseSeed
    {
        ...
        private static void InitOtherData<TDbContext>(TDbContext dbContext) where TDbContext : DbContext
        {
            ...
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('22e89a74-3e03-4f1d-7d6b-08d708fe7bef',N'组织结构管理-添加组织','Group','POST','/api/group')");
            ...
            dbContext.Database.ExecuteSqlCommand("INSERT INTO  \"Api\"(\"Id\",\"Name\",\"Controller\",\"Type\",\"Address\")VALUES('6330e0bd-42fc-4ac6-7d71-08d708fe7bef',N'角色管理-添加角色','Role','POST','/api/role')");
